...
<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color="blue"><b> All <font color="red"><b>*</b></font> Text Box Are  Mandatory</b></font></p> 
					...
					<div class="panel panel-default">
						<div class="panel-heading" style="background-color: #cff2f9;">Applicant
							Address And Contact Details </div>
						<div class=" panel-body ">
							<div class="panel-group">
								<div>
					...
					<div class="panel panel-primary">
                      ...
                      <div class="panel panel-default">
						<div class="panel-heading" style="background-color: #cff2f9;">Occupancy Certificate details</div>
						<div class="panel-body">
						<div class="form-group">
						<label class="col-md-2 control-label">Occupancy Certificate:</label>
						<div class="col-md-4 inputGroupContainer">
						<div class="input-group">
						<input type="radio" id="O_certificate" name="O_certificate"
						value="Y" checked="checked"> Yes <input
						type="radio" id="O_certificate" name="O_certificate" value="N">
						No
						</div>
						</div>
						</div>                       
										...
										<div class="col-md-3 inputGroupContainer">
											<div class="input-group">
												<select class="form-control" name="cmbbcls" id="cmbbcls9"
													onchange="javascript:getusage('9')">
													<option value="0">-Select-</option>
												</select>
											</div>
										</div>
										...
										<div class="col-md-3 inputGroupContainer">
											<div class="input-group">
												<select class="form-control" name="cmbbcls" id="cmbbcls10"
													onchange="javascript:getusage('10')">
													<option value="0">-Select-</option>
												</select>
											</div>
										</div>
										...
										<div class="col-md-3 inputGroupContainer">
											<div class="input-group">
												<select class="form-control" name="cmbbcls" id="cmbbcls11"
													onchange="javascript:getusage('11')">
													<option value="0">-Select-</option>
												</select>
											</div>
										</div>
										...
										<div class="col-md-3 inputGroupContainer">
											<div class="input-group">
												<select class="form-control" name="cmbbcls" id="cmbbcls12"
													onchange="javascript:getusage('12')">
													<option value="0">-Select-</option>
												</select>
											</div>
										</div>
									...
									<div class="panel-body">
										<div class="form-group">
                                            ...
                                            <div class="col-md-12" style="line-height: 35px">
												...
												<div class="col-md-5">
													<input name="file4" id="fileToUpload4" type="file">
												</div>
											</div>
