				...
				<div class="panel panel-primary">
					...
					<div class="panel-body">
						...
						<div class="col-md-6">
							<label class="col-md-4 ">Name :</label>
								<div class="col-md-4 ">
									<div class="input-group">
										<c:out value="${getUniqueData[1]} ${getUniqueData[2]}" />
									</div>
								</div>
							</div>
							<div class="col-md-6">
							...
							<div class="col-md-6">
								<label class="col-md-4 "> PTSelf AssessmentNo:</label>
								<div class="col-md-4 ">
									<div class="input-group">
								...
								<label class="col-md-4 ">OWNER ADDRESS :</label>
								<div class="col-md-4 ">
									<div class="input-group">
										<c:out value="${getUniqueData[1]}" />
									</div>
								</div>
							</div>							<div class="col-md-6">
								<label class="col-md-4 ">PT Self AssessMent Amount:</label>
								<div class="col-md-4 ">
									<div class="input-group">
										<c:out value="${getUniqueData[7]}" />
									</div>
								</div>
							</div>
							</c:forEach>
							...
							<input type="hidden" name="feeamount" id="feeamount" value="<c:out value="${getUniqueData[7]}" />"/>
