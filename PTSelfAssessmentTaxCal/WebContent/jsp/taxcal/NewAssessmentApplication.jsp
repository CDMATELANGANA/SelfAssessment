...
${msg}
								...
								<div class="col-md-4 inputGroupContainer">
									<div class="input-group">
										<input name="ownerSurName" id="ownerSurName"
											placeholder="Owner SurName" class="form-control" type="text"  value="${list.surname}">
								...
								<div class="col-md-4 inputGroupContainer">
									<div class="input-group">
										<input name="ownerName" id="ownerName"
											placeholder="Owner Name" class="form-control" type="text"  value="${list.ownername}">
									</div>
								</div>
							</div>
								...
								<div class="col-md-4 inputGroupContainer">
									<div class="input-group">
										<input name="ownerFatherHusbandSurName"
											...
											type="text" value="${list.relationsurname}">
									</div>
								</div>
							</div>
								...
								<div class="col-md-4 inputGroupContainer">
									<div class="input-group">
										<input name="ownerFatherHusbandName"
											...
											class="form-control" type="text" value="${list.relationname}">
									</div>
								</div>
							</div>
								...
								<div class="col-md-4 inputGroupContainer">
									<div class="input-group">
										...
										<input name="ownerAadhar" id="ownerAadhar"
											placeholder="Owner Aadhar" class="form-control" type="text" value="${list.aadharnumber}">
									</div>
 ...
 -->
										...
										<div class="col-md-4  inputGroupContainer">
											<div class="input-group">
												...
												<input name="ownerVilliage" id="ownerVilliage"
													placeholder="Owner City" class="form-control" type="text" value="${list.ownercity}">
											</div>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-md-4  ">
											<div class="input-group">
												...
												<input name="ownerMobile" id="ownerMobile"
													placeholder="Mobile" class="form-control" type="text" value="${list.mobilenumber}">
											</div>
										</div>
									</div>
										...
										<div class="col-md-4 ">
											<div class="input-group">
												...
												<input name="occupantname" id="occupantname"
													...
													type="text" value="${list.occupantname}">
											</div>
										</div>
									</div>
										...
										<div class="col-md-4  ">
											<div class="input-group">
												...
												<input name="occupantsurname" id="occupantsurname"
													...
													type="text" value="${list.occupantsurname}">
											</div>
										</div>
									</div>
						...
						<div class="list-group">
							<div class="panel panel-default">
								<div class="panel-heading" style="background-color: #cff2f9;">
									...
									<!-- :<a data-toggle="modal"
											data-target="#myModel1">List of Documents for New Assessment </a> -->
								</div>
								<div class="panel-body">
									<div class="form-group">
				...
				<input type="hidden" name="dtcpappno" id="dtcpappno" value="${list.id}">
...
<script type="text/javascript">
	function checkValidation() {
		...
		if (!ownerPinCode_Regx.test(ownerPinCode)) {
			document.getElementById("errorBoxBasic").innerHTML = "Enter valid Pincode/ Only 6 digits are allowed  ";
