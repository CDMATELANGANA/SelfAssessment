								...
								<table id="gridview" 
									...
									<thead>
										<tr style="background-color: #b9e9ff; font-size: 14px">
				                            ...
				                            <th style="text-align: center;" class="col-md-1">Entry Date</th>
				                            <th style="text-align: center;" class="col-md-1">Payment Transaction ID</th>
				                            <th style="text-align: center;" class="col-md-1">Del Flag</th>
				                            <th style="text-align: center;" class="col-md-1">Payment Flag</th>	
				                            <th style="text-align: center;" class="col-md-1">Initiate</th>					
										</tr>
									</thead>
									<tbody>
										<c:forEach items="${ulbDuplicateList}" var="ulbDuplicateList"	varStatus="theCount">
											<tr style="font-size: 13px; color: #00000F;">
												<td style="text-align: center;">${theCount.count}</td>
												<td style="text-align: center;">${ulbDuplicateList[0]}</td>
												<td style="text-align: center;">${ulbDuplicateList[1]}</td>
												<td style="text-align: center;">${ulbDuplicateList[2]}</td>
												<td style="text-align: center;">${ulbDuplicateList[3]}</td>
												<td style="text-align: center;">${ulbDuplicateList[4]}</td>
												<td style="text-align: center;">${ulbDuplicateList[5]}</td>
												<td style="text-align: center;">${ulbDuplicateList[6]}</td>
												<td style="text-align: center;">${ulbDuplicateList[7]}</td>
												<td style="text-align: center;">${ulbDuplicateList[8]}</td>
