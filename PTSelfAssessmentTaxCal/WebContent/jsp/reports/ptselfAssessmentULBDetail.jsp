...
%>
<script type="text/javascript" src="../jsp/js/jquery-1.3.2.min.js"></script>
	...
	<div class="container">
		...
		<div class="panel with-nav-tabs">
			<div class="panel-heading">
				<ul class="nav nav-tabs">
					<li style="width: 50%" class="active"><a data-toggle="tab"
						href="#home" style="text-align: center;">ULB Report</a></li>
					<li style="width: 50%"><a data-toggle="tab" href="#menu1"
						style="text-align: center;">Gateway Report</a></li>

				</ul>
			</div>
		</div>
		<c:forEach items="${detailReport}" var="item" varStatus="index">
			<c:set var="ulb" value="${item[5]}"></c:set>
		</c:forEach>
		<form action="<%=path%>/ptselfAssessmentTransDtlsByDate.do">
		...
		<div class="row">
			<div class="tab-content">
				...
				<c:choose>
					<c:when
						test="${(nm == 'wtax')||(nm == 'trade')||(nm == 'tradeRenw')||(nm == 'adv')}">
							...
							<div class="col-md-12" style="color: black">
								...
								<table id="ulbTable" class="display" cellspacing="0">
									...
									<tbody>
										...
										<c:forEach items="${detailReport}" var="item"
											varStatus="index">
											<tr>
												<td>${index.count}</td>
												<td>${item[1]}</td>
								...
								<table id="ulbTable" class="display" cellspacing="0"
									...
									<thead>
										<tr>
											...
											<th style="text-align: center;">UniqueRequestNo.</th>
											<th style="text-align: center;">Payment TransId</th>
											<th style="text-align: left;">Amount</th>
											<th style="text-align: center;">Transaction Date</th>
											<th style="text-align: center;">Owner name</th>
											<!-- <th style="text-align: center;">Door No</th> -->
											<th style="text-align: center;">Bank TransId</th>
						...
						<div class="col-md-5">
							...
							<div class="box box-widget widget-user-2">
								...
								<div class="box-footer no-padding">
									<ul class="nav">
										<li><span class="col-md-4">GATEWAY</span> <span
											class="col-md-4">TRANSACTIONS</span> <span class="col-md-4">AMOUNT</span></li>
										<li><span class="col-md-4">${gateway[0][0]}</span> <span
											class="col-md-4">${gateway[0][1]}</span> <span
											class="col-md-4">${gateway[0][2]}</span></li>
										<li><span class="col-md-4">${gateway[1][0]}</span> <span
											class="col-md-4">${gateway[1][1]}</span> <span
											class="col-md-4">${gateway[1][2]}</span></li>
										<li><span class="col-md-4">${gateway[2][0]}</span> <span
											class="col-md-4">${gateway[2][1]}</span> <span
											class="col-md-4">${gateway[2][2]}</span></li>
										<li><span class="col-md-4">Total</span> <span
											class="col-md-4">${gateway[0][1] + gateway[1][1]+
												gateway[2][1] }</span> <span class="col-md-4">${gateway[0][2]
												+ gateway[1][2] + gateway[2][2]} </span></li>
									</ul>
								</div>
							</div>
							<!-- /.widget-user -->
