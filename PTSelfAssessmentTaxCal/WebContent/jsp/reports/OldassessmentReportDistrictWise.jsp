								...
								<table id="gridview" title="${date_interval}"
									...
									<thead>
										<tr style="background-color: #b9e9ff; font-size: 14px">
											...
											<!-- <th align="center" class="col-md-6">District--</th> -->
										...
										<c:forEach items="${asmntList}" var="asmntList"
											...
											<tr style="font-size: 13px; color: #00000F;">
												...
												<td style="text-align: center;"><a
													href="getOldAssmntBySelectedDistrictWise.do?dist_id=${asmntList[0]}"
									...
									<tbody>
										<c:forEach items="${asmntList}" var="asmntList"
											...
											<tr style="font-size: 13px; color: #00000F;">
												<td style="text-align: center;"></td>
												<td style="text-align: center;"><a
													href="getOldAssmntBySelectedUlbWise.do?ulb_id=${asmntList[0]}"
