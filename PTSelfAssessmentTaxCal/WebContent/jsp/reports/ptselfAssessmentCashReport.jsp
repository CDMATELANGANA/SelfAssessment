  ...
  <%--  <p>${value[0]}</p>
     <p>${value[1]}</p> --%>
          ...
          <!--   &#8377; -->
              ...
              <p>PtSelfAssessment Cash Payment Report <span style="float: right;"><sup style="font-size: 13px;font-family:sans-serif;">From 16-08-2019 </sup></span></p> 
        ...
        <p align="center">
        <a href="./ptpaymentDetail.do" class="small-box-footer" ><font color="black">More info <i class="fa fa-arrow-circle-right"></i></font></a></p>
          </div>
          <p>&nbsp;&nbsp;</p>
          <p>&nbsp;&nbsp;</p>
          <p>&nbsp;&nbsp;</p>
