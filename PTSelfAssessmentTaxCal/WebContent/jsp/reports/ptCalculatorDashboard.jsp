	...
	<div class="container">
		...
		<fieldset>
			<div class="panel panel-primary">
				<div class="panel-heading">PT Calculator
					Dashboard</div>
				...
				<div class=" panel-body ">
					<div class="panel-group" align="center">
						...
						<div class="col-md-8" align="center">
							<a href="getPtCalculatorAllDistrictWise.do">
							<c:forEach items="${TotalVisit}" var="TotalVisit">
									<table id="gridview" title="${date_interval}"
										...
										<tbody>
											<tr style="background-color: #b9e9ff; font-size: 14px">
												<th align="center" class="col-md-6">Total PT Calculator Visitors</th>
												<th align="center" class="col-md-6">${TotalVisit}</th>
												<!-- <th align="center" class="col-md-6">0</th> -->
											</tr>
										</tbody>
