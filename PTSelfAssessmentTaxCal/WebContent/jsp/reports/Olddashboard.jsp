				...
				<div class=" panel-body ">
					<div class="panel-group" align="center">
						...
						<div class="col-md-8" align="center">
							<a href="getOldAssmntByAllDistrictWise.do"><c:forEach
...
<!-- Changed By Rahul This is Useful for future use -->
										<%-- <tbody>
											<tr style="background-color: #b9e9ff; font-size: 14px">
												<th align="center" class="col-md-6">Under RO/RI Login</th>
												<th align="center" class="col-md-6">${dashborad[4]-dashborad[2]-dashborad[3]-dashborad[5]==null?"0":dashborad[4]-dashborad[2]-dashborad[3]-dashborad[5]}</th>
											</tr>
										</tbody>
										...
										<tbody>
											<tr style="background-color: #b9e9ff; font-size: 14px">
												<th align="center" class="col-md-6">Under Commissioner
													Login</th>
												<th align="center" class="col-md-6">${dashborad[2]==null?"0":dashborad[2]}</th>
											</tr>
										</tbody>
										...
										<tbody>
											<tr style="background-color: #b9e9ff; font-size: 14px">
												<th align="center" class="col-md-6">Applications
													Approved</th>
												<th align="center" class="col-md-6">${dashborad[5]==null?"0":dashborad[2]}</th>
											</tr>
										</tbody>
										...
										<tbody>
											<tr style="background-color: #b9e9ff; font-size: 14px">
												<th align="center" class="col-md-6">Applications
													Rejected</th>
												<th align="center" class="col-md-6">${dashborad[3]==null?"0":dashborad[2]}</th>
											</tr>
										</tbody>
										<tbody>
											<tr style="background-color: #b9e9ff; font-size: 14px">
...
<!-- End of 1st stage  -->
	...
	<!-- Comment of second Stage date 14-03-2019 -->		
			<!-- CMS Dashboard -->
			<%-- <div class="panel panel-primary">
				<div class="panel-heading">PT Self Assessment
					Dashboard - Citizen Service Center</div>

				<div class=" panel-body ">
					<div class="panel-group" align="center">
						<div class="col-md-2"></div>
						<div class="col-md-8" align="center">
							<a href="getAssmntByAllDistrictWiseCMS.do"><c:forEach
									items="${districtCMS}" var="dashborad">
									<table id="gridview" title="${date_interval}"
										class="table table-condensed table-hover table-striped display cell-border"
										style="color: #00000F;">
										<!-- 	<thead>
										...
										<tbody>
											<tr style="background-color: #b9e9ff; font-size: 14px">
												<th align="center" class="col-md-6">Under Commissioner
													Login</th>
												<th align="center" class="col-md-6">${dashborad[2]==null?"0":dashboard[2]}</th>
											</tr>
										</tbody>
										...
										<tbody>
											<tr style="background-color: #b9e9ff; font-size: 14px">
												<th align="center" class="col-md-6">Applications
													Approved</th>
												<th align="center" class="col-md-6">${dashborad[5]==null?"0":dashboard[5]}</th>
											</tr>
										</tbody>
										...
										<tbody>
											<tr style="background-color: #b9e9ff; font-size: 14px">
												<th align="center" class="col-md-6">Applications
													Rejected</th>
												<th align="center" class="col-md-6">${dashborad[3]==null?"0":dashboard[3]}</th>
											</tr>
										</tbody>
										<tbody>
											<tr style="background-color: #b9e9ff; font-size: 14px">
			...
			<%-- <div class="panel panel-primary">
				...
				<div class=" panel-body ">
					<div class="panel-group" align="center">
						<div class="col-md-2"></div>
						<div class="col-md-8" align="center">
							<a href="getAssmntByAllDistrictWiseMob.do"><c:forEach
									items="${districtMob}" var="dashborad">
									<table id="gridview" title="${date_interval}"
										class="table table-condensed table-hover table-striped display cell-border"
										style="color: #00000F;">
										...
										<tbody>
											<tr style="background-color: #b9e9ff; font-size: 14px">
												<th align="center" class="col-md-6">Under Commissioner
													Login</th>
												<th align="center" class="col-md-6"><c:if test="${empty dashborad[2]}">0</c:if>${dashborad[2]}</th>
											</tr>
										</tbody>
										...
										<tbody>
											<tr style="background-color: #b9e9ff; font-size: 14px">
												<th align="center" class="col-md-6">Applications
													Approved</th>
												<th align="center" class="col-md-6"><c:if test="${empty dashborad[5]}">0</c:if>${dashborad[5]}</th>
											</tr>
										</tbody>
										...
										<tbody>
											<tr style="background-color: #b9e9ff; font-size: 14px">
												<th align="center" class="col-md-6">Applications
													Rejected</th>
												<th align="center" class="col-md-6"><c:if test="${empty dashborad[3]}">0</c:if>${dashborad[3]}</th>
											</tr>
										</tbody>
										<tbody>
											<tr style="background-color: #b9e9ff; font-size: 14px">
