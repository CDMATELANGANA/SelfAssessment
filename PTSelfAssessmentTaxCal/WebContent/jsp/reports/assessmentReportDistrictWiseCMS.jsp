				...
				<div class=" panel-body ">
					<div class="panel-group" align="center">
						...
						<c:if test="${repotype == 'district'}">
							...
							<a href="getAssmntByAllUlbWiseCMS.do"
										...
										<c:forEach items="${asmntList}" var="asmntList"
											...
											<tr style="font-size: 13px; color: #00000F;">
												...
												<td style="text-align: center;"><a
													href="getAssmntBySelectedDistrictWiseCMS.do?dist_id=${asmntList[0]}"
									...
									<tbody>
										<c:forEach items="${asmntList}" var="asmntList"
											...
											<tr style="font-size: 13px; color: #00000F;">
												<td style="text-align: center;"></td>
												<td style="text-align: center;"><a
													href="getAssmntBySelectedUlbWiseCMS.do?ulb_id=${asmntList[0]}"
