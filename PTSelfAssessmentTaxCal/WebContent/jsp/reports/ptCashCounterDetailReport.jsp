...
<a href="./ptSelfAssesmntAllCashTransaction.do"><h3 style="color:red;">Click Here For Detail Transaction Report</h3></a>
<div style="background-color:#E6E6FA" class="col-md-12"><br>
<form  action="<%=path%>/ ptAssessmentCashIntervalData.do" >
<%-- <div class="col-md-12" >
									...
									<c:choose>
										<c:when test="${(fromDate != null) && (toDate != null)}">
											<td style="text-align: center;"><a
												href="./ ptAssessmentCashIntervalData.do?fromDate=${fromDate}&&toDate=${toDate}">${item[2]}</a></td>
										</c:when>
										<c:otherwise>
											<td style="text-align: center;"><a href="./ptAssessementCashDetailULB.do?ulb=${item[3]}">${item[1]}</a></td>
