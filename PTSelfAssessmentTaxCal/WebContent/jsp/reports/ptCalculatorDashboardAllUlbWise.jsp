	...
	<div class="container">
		...
		<fieldset>
			<div class="panel panel-primary">
				<div class="panel-heading">PT Calculator All Ulb Wise Dashboard</div>
				...
				<div class=" panel-body ">
					<div class="panel-group" align="center">
						...
						<%-- <c:if test="${repotype == 'district'}"> --%>
							...
							<!-- <a href="getPtCalculatorUlbWise.do"
								...
								<table id="gridview" title="${date_interval}"
									...
									<thead>
										<tr style="background-color: #b9e9ff; font-size: 14px">
											...
											<th align="center" class="col-md-4" style="text-align: center;">ULB Under District</th>
											<th align="center" class="col-md-4" style="text-align: center;">Total No. Of Visitor</th>
											<th align="center" class="col-md-2">Total Tax</th>
										</tr>
									</thead>
									<tbody>
										<c:set var="district" value="0"></c:set>
										<c:set var="visitor" value="0"></c:set>
										<c:set var="ulb" value="0"></c:set>
										<c:set var="totaltax" value="0"></c:set>
											<c:forEach items="${ulbList}" var="ulbList"
											varStatus="valCount">
											<tr style="font-size: 13px; color: #00000F;">
												<td style="text-align: center;"></td>
												
												<td style="text-align: center;">${ulbList[2]}</td><c:set var="ulb" value=""></c:set>
												<td style="text-align: center;">${ulbList[1]}</td><c:set var="district" value=""></c:set>
												<td style="text-align: center;">${ulbList[5]}</td><c:set var="visitor" value="${visitor+ulbList[5]}"></c:set>
												<td style="text-align: center;">${ulbList[4]}</td><c:set var="totaltax" value="${totaltax+ulbList[4]}"></c:set>
 											</tr>
										</c:forEach>
									</tbody>
									<tfoot>
										<tr style="background-color: #f3f8fa">
											<th style="text-align: center; border: 1px solid #9ee4fe;" colspan="3">Total:</th>
