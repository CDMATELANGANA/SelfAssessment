			...
			<div class="panel panel-primary">
				...
				<div class=" panel-body ">
					<div class="panel-group" align="center">
						...
						<form method="get"
							action="selfMutationTransactionStatusReportByUniqId.do"
							...
							<table id="gridview"
								...
								<thead>
									<tr style="background-color: #b9e9ff; font-size: 13px">
										...
										<th align="center" class="col-md-1">PT Self Assessment ULB</th>
										...
										<%-- 	<td>${tranList[8]}</td>  --%>
											...
											<td><c:choose>
													<c:when
														...
														<a
															href="updateInitiateTransactionStatusDB2.do?trans_id=${tranList[10]}&uniqReqNo=${tranList[11]}"
