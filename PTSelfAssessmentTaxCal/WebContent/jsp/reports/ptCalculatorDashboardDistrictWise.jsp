	...
	<div class="container">
		...
		<fieldset>
			<div class="panel panel-primary">
				<div class="panel-heading">PT Calculator District Wise Dashboard</div>
								...
								<table id="gridview" title="${date_interval}"
									...
									<thead>
										<tr style="background-color: #b9e9ff; font-size: 14px">
											...
											<th align="center" class="col-md-4" style="text-align: center;">District</th>
			...
			<a href="getPtCalculatorUlbWise.do?districtcode=${districtList[0]}"style="color: #00000F; font-weight: bold;">
												${districtList[1]}</a></td><c:set var="district" value=""></c:set>
												<td style="text-align: center;">${districtList[5]}</td><c:set var="visitor" value="${visitor+districtList[5]}"></c:set>
												<td style="text-align: center;">${districtList[4]}</td><c:set var="totaltax" value="${totaltax+districtList[4]}"></c:set>
 											</tr>
										</c:forEach>
									</tbody>
									<tfoot>
