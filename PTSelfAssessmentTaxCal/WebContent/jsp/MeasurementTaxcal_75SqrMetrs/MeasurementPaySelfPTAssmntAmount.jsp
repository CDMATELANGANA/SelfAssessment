...
<body>
	<div class="container_12">
		...
		<div class="col-md-12">
							...
							<div class="col-md-4 ">
								<div class="input-group">
									<form action="MeasurementCashcounterLogin.do" name="requestnumber" method="post">
		...
		<!-- End Cheque  -->				
						<div class="col-md-12">
							...
							<div class="col-md-4 ">
								<div class="input-group">
									<form action="ptselfAssessmentPayForMeasurement.do" name="requestnumber" method="post">
										<input type="hidden" name="requestnumber" id="requestnumber"
											value="<c:out value="${UniqueNumber}"/>"> <input
